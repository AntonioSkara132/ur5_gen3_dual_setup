...
def generate_launch_description():
    ...
    DeclareLaunchArgument(
        "ur_name",
        default_value="ur5",
        description="Name of UR robot",
    ),
    DeclareLaunchArgument(
        "ur_type",
        default_value="ur5",
        description="UR robot type (ur3, ur5, ur5e, ur10e, ...)"
    ),
    DeclareLaunchArgument(
        "ur_ros_namespace",
        default_value="ur",
        description="ROS namespace for UR robot"
    ),
    DeclareLaunchArgument(
        "ur_controllers_file",
        default_value="ros2_controllers.yaml",
        description="Controllers YAML for UR robot"
    ),
