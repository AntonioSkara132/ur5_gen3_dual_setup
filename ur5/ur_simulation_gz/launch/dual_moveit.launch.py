...
def launch_setup(context, *args, **kwargs):
    ...
    gz_spawn_entity = Node(
        ...
        executable="create",
        output="screen",
        arguments=["-string", robot_description_content, "-name", "dual_robot_system"],
        #namespace=robot_namespace,
    )
    ...
    ur_initial_joint_controller_spawner_started = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[initial_ur_joint_controller, "-c", ur_cm_path],
    ...
    ur_initial_joint_controller_spawner_stopped = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[initial_ur_joint_controller, "-c", ur_cm_path, "--stopped"],
